.PHONY: all clean csvs p4-csvs wellbore-csvs p5-csvs db attribution lng-attribution
...
# Generate all CSV files from EBCDIC data
csvs: p4-csvs wellbore-csvs p5-csvs

# P4 (lease/producer) data
p4-csvs: data/root.csv data/info.csv data/gpn.csv data/lease_name.csv
...
# Well bore data
wellbore-csvs: data/wellbore_root.csv data/wellbore_location.csv data/wellbore_wellid.csv
...
p5-csvs: data/p5_org.csv data/p5_specialty.csv data/p5_officer.csv data/p5_activity.csv
