...
data/data.duckdb: data/root.csv data/info.csv data/gpn.csv data/lease_name.csv data/wellbore_root.csv data/wellbore_location.csv data/wellbore_wellid.csv data/sources_2025-09-30T20_18_37.074Z.json queries/load_db.sql queries/load_wellbore.sql queries/load_emissions.sql queries/schema.sql
